...
public abstract class FileDialog : CommonDialog
{
	...
	public StringView Title { get; set; }
	
	public StringView InitialDirectory { get; set; }
	
	public String[] FileNames => null;
	
	public StringView FileName { set; }
	...
	public Result<void> SetFilter(StringView value) => default;
}
